...
/**
 * Class to test DegreeClassifierMutation2.
 * MUTATION 2: Changed logical OR to logical AND in the validation
 */
public class DegreeClassifierMutation2Test {

    private DegreeClassifierMutation2 classifier;

    @BeforeEach
    public void setUp() {
        classifier = new DegreeClassifierMutation2();
    }
