...
/**
 * Class to test DegreeClassifierMutation3.
 * MUTATION 3: Swapped return values for 2:2 and Third-Class
 */
public class DegreeClassifierMutation3Test {

    private DegreeClassifierMutation3 classifier;

    @BeforeEach
    public void setUp() {
        classifier = new DegreeClassifierMutation3();
    }
