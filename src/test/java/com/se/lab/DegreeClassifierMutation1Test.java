...
/**
 * Class to test DegreeClassifierMutation1.
 * MUTATION 1: Changed First-Class boundary from 70 to 75
 */
public class DegreeClassifierMutation1Test {

    private DegreeClassifierMutation1 classifier;

    @BeforeEach
    public void setUp() {
        classifier = new DegreeClassifierMutation1();
    }
